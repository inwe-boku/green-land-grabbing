...
joined_data_region_wind <-
  aggregate_data_by_region(joined_data_wind)
...
joined_data_region_full_wind <-
  aggregate_data_by_region_full(joined_data_region_wind)
...
joined_data_wind <-
  get_full_owners_investors_aneel_windparks_including_parents(
    join_bloomberg_aneel_owners,
    join_bloomberg_aneel_investors,
...
p <-
  do_sankey(title = "Owner", joined_data_wind_, "Direct owner", 6, "I",-1, 0.7, 0.3, 1)
p
ggsave("figures/sankey-wind-owner.eps",
       p,
       width = 12,
       height = 6)
ggsave("figures/sankey-wind-owner.pdf",
       p,
       width = 12,
       height = 6)
ggsave("figures/sankey-wind-owner.png",
       p,
       width = 12,
       height = 6)
...
p <-
  do_sankey(title = "Investor",
            ...
            1)
p
ggsave("figures/sankey-wind-investor.eps",
       p,
       width = 12,
       height = 6)
ggsave("figures/sankey-wind-investor.pdf",
       p,
       width = 12,
       height = 6)
ggsave("figures/sankey-wind-investor.png",
       p,
       width = 12,
       height = 6)
